public class KnapsackUnbounded {
    /*
     * Implementation of the classic knapsack problem with no bound.
     * Note: Time complexity of O(nW) s.t. n is number of items and W is weights of items
     */
    ...
    /*
     *  The maximum achievable profit of selecting a subset of the elements such that the
